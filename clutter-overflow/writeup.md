...
We iteratively run `echo $OVERFLOW | ./chall` , where OVERFLOW is a string of A's of length > 256. We find that 4 bytes overflow into `code` when the length of OVERFLOW is 268:
